...
{
    public record AddItemsToManualCollection(int CollectionId, List<CollectionItemRequest> Items) 
        : IRequest<Either<BaseError, MediatR.Unit>>;

    public class AddItemsToManualCollectionHandler : IRequestHandler<AddItemsToManualCollection, Either<BaseError, MediatR.Unit>>
    {
        ...
        public async Task<Either<BaseError, MediatR.Unit>> Handle(
            AddItemsToManualCollection request,
