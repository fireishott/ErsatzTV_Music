...
{
    public record RemoveItemsFromManualCollection(int CollectionId, List<int> ItemIds) 
        : IRequest<Either<BaseError, MediatR.Unit>>;

    public class RemoveItemsFromManualCollectionHandler : IRequestHandler<RemoveItemsFromManualCollection, Either<BaseError, MediatR.Unit>>
    {
        ...
        public async Task<Either<BaseError, MediatR.Unit>> Handle(
            RemoveItemsFromManualCollection request,
