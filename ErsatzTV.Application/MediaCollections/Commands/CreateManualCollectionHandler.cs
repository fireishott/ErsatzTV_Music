...
public class CreateManualCollectionHandler : IRequestHandler<CreateManualCollection, Either<BaseError, CreateManualCollectionResult>>
{
    ...
    public async Task<Either<BaseError, CreateManualCollectionResult>> Handle(
        CreateManualCollection request,
