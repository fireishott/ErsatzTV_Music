...
public class UpdateManualCollectionHandler : IRequestHandler<UpdateManualCollection, Either<BaseError, UpdateManualCollectionResult>>
{
    ...
    public async Task<Either<BaseError, UpdateManualCollectionResult>> Handle(
        UpdateManualCollection request,
